...
# Initiative Tracker[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#initiative-tracker "Permanent link")
...
## Quick Start Example[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#quick-start-example "Permanent link")

`~~~ds-initiative heroes:   - name: "Frodo Baggins"     max_stamina: 80     image: "images/frodo.png"   - name: "Samwise Gamgee"     max_stamina: 90     image: "images/sam.png" enemy_groups:   - name: "Mordor Forces"     creatures:       - name: "Orc"         max_stamina: 40         amount: 4         image: "images/orc.png"       - name: "Troll"         max_stamina: 150         amount: 1         image: "images/troll.png" villain_power:   value: 5 ~~~`
...
## How to Use[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#how-to-use "Permanent link")
...
### Code Block Structure[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#code-block-structure "Permanent link")

`~~~ds-initiative # Your encounter data here heroes:   - name: "Aragorn"     max_stamina: 120 enemy_groups:   - name: "Orc Horde"     creatures:       - name: "Orc Warrior"         max_stamina: 50         amount: 3 villain_power:   value: 2 ~~~`

## Encounter Data Format[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#encounter-data-format "Permanent link")
...
### Heroes[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#heroes "Permanent link")

#### Hero Fields[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#hero-fields "Permanent link")
...
#### Example[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#example "Permanent link")

`heroes:   - name: "Gandalf"     max_stamina: 100     current_stamina: 85     temp_stamina: 5     image: "images/gandalf.png"     conditions:       - "blinded"`

### Enemy Groups[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#enemy-groups "Permanent link")

An enemy group represents a collection of creatures that act together in the initiative order.

#### Enemy Group Fields[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#enemy-group-fields "Permanent link")
...
#### Creatures[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#creatures "Permanent link")
...
#### Creature Instance Fields[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#creature-instance-fields "Permanent link")
...
#### Example[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#example_1 "Permanent link")

`enemy_groups:   - name: "Goblin Gang"     creatures:       - name: "Goblin"         max_stamina: 30         amount: 5         image: "images/goblin.png"   - name: "Undead Horde"     is_squad: true     creatures:       - name: "Skeleton"         max_stamina: 10         amount: 10         image: "images/skeleton.png"         squad_role: minion`

In this example, "Goblin Gang" is a regular enemy group, while "Undead Horde" is a minion group consisting of 10 Skeletons.

### Minions and Captains[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#minions-and-captains "Permanent link")
...
### Villain Power[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#villain-power "Permanent link")

#### Fields[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#fields "Permanent link")

- `value` (number, required): The current villain power level.

#### Example[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#example_2 "Permanent link")

`villain_power:      value: 3`

## Interacting with the Tracker[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#interacting-with-the-tracker "Permanent link")

Once your encounter is defined, the Initiative Tracker provides an interactive UI in your note.

### Heroes[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#heroes_1 "Permanent link")
...
### Enemy Groups[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#enemy-groups_1 "Permanent link")
...
### Stamina Pool Modal for Minions[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#stamina-pool-modal-for-minions "Permanent link")
...
![minion-stamina-pool-modal](https://steelcompendium.io/draw-steel-elements/Media/minion-stamina-pool-modal.png)

### Villain Power[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#villain-power_1 "Permanent link")

**Adjusting**: Use the up and down arrows next to the villain power display to increase or decrease the value.

### Reset Round[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#reset-round "Permanent link")

Click the "Reset Round" button to clear all turn indicators and start a new round.

### Reset Encounter State[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#reset-encounter-state "Permanent link")
...
### Stamina Management[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#stamina-management "Permanent link")

![initiative-tracker-stamina-modal.png](https://steelcompendium.io/draw-steel-elements/Media/initiative-tracker-stamina-modal.png)

#### Adjusting Stamina Incrementally[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#adjusting-stamina-incrementally "Permanent link")
...
#### Applying Specific Damage or Healing[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#applying-specific-damage-or-healing "Permanent link")
...
#### Managing Temporary Stamina[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#managing-temporary-stamina "Permanent link")

- Use the **"+"** and **"-"** buttons next to the temporary stamina value.
- Edit the temporary stamina value directly in the input field.

#### Quick Modifiers[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#quick-modifiers "Permanent link")
...
### Conditions[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#conditions "Permanent link")

Conditions represent status effects affecting heroes or creatures, such as "dazed" or "slowed".

![initiative-tracker-add-conditions](https://steelcompendium.io/draw-steel-elements/Media/initiative-tracker-add-conditions.png)
...
### Data Persistence[¶](https://steelcompendium.io/draw-steel-elements/initiative-tracker/#data-persistence "Permanent link")
