...
effects:
  ...
  - name: Potential Challenges
    effect: |
      ...
      - **Scale the Outer Wall:** Climb a treacherous section of the keep's wall. (Athletics + Agility)
      - **Bypass the Sentry Post:** Sneak past a tower with distracted guards. (Stealth + Intuition)
      - **Disable Courtyard Traps:** Identify and disarm pressure plates and tripwires. (Thievery + Reason)
      - **Create a Diversion:** Cause a commotion on the other side of the keep to draw patrols away. (Deception + Presence)
